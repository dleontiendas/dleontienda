    ...
    <div className="row">
      ...
      <div className="col s12 m5 center">
        <img
          ...
          style={{ borderRadius: "10px", maxHeight: "800px", objectFit: "contain" }}
        />
      </div>
    ...
    <div className="row" style={{ marginTop: "40px" }}>
      <div className="col s12 text-left">
        <ul className="collection with-header">
          ...
          <li className="collection-item">Categoría: {product.category || "—"}</li>
          <li className="collection-item">Subcategoría: {product.subcategory || "—"}</li>
          <li className="collection-item">Peso: {product.weight_g || "—"} g</li>
          <li className="collection-item">Garantía: {product.warranty || "—"}</li>
          <li className="collection-item">Materiales: {product.materials || "—"}</li>
          <li className="collection-item">Cuidados: {product.care_instructions || "—"}</li>
        </ul>
      </div>
    </div>
  </div>
